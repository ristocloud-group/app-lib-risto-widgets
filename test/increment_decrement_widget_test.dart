...
void main() {
  group('IncrementDecrementWidget - Synchronous Callbacks', () {
    testWidgets('Initial state is displayed correctly', (
      ...
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(body: _IncrementDecrementSyncTestWidget())),
      );
    ...
    testWidgets('Decrement button is disabled when quantity is at minValue', (
      ...
      final decrementButton = find.widgetWithIcon(
        CustomActionButton,
        Icons.remove,
      );
    ...
    testWidgets('Increment button is disabled when quantity is at maxQuantity', (
      ...
      final incrementButton = find.widgetWithIcon(
        CustomActionButton,
        Icons.add,
      );
  ...
  group('IncrementDecrementWidget - Asynchronous Callbacks', () {
    testWidgets('Initial state is displayed correctly', (
      ...
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(body: _IncrementDecrementAsyncTestWidget())),
      );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(body: _IncrementDecrementAsyncTestWidget()),
          ),
        );
  ...
  group('IncrementDecrementWidget - Connected Factory & Value Builder', () {
    testWidgets(
      'Connected factory renders correctly with custom valueBuilder and clamping',
      (WidgetTester tester) async {
        ...
        // Verify the custom builder text is rendered
        ...
        // Verify the custom builder text updated to 6
        expect(find.text('Custom: 6'), findsOneWidget);

        // Tap the custom button to inject 999
